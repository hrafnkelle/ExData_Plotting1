...
hist(pow$Global_active_power, xlab="Global Active Power (kilowatts)",xaxt='n',col="red",main="Global Active Power",ylim=c(0,1200))
axis(side=1, at=seq(0,7,2), labels=seq(0,7,2),xlim=c(0,10))
dev.off()
